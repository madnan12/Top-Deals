    ...
    $.fn.formset = function(opts)
    {
        ...
        if ($$.length) {
            ...
            addButton.click(function() {
                ...
                let form_latest_card = row[0]
                let created_inp = document.createElement('input')
                created_inp.setAttribute('type' , 'hidden')
                created_inp.setAttribute('required' , 'false')
                created_inp.classList.add('created_field')
                created_inp.value = 1
                form_latest_card.appendChild(created_inp)
